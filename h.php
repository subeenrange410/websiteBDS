            ...
            <a href="#" onclick="confirmLogout()">Đăng xuất</a>
              ...
              function confirmLogout() {
                if (confirm("Bạn có chắc chắn muốn thoát?")) {
                  // Nếu người dùng xác nhận thoát, chuyển đến trang logout.php để đăng xuất
                  ...
                  <tr>
                    ...
                    <th>Feedback admin</th>
                          ...
                          <?php
                                ...
                                // Truy vấn cơ sở dữ liệu để lấy feedback và feedback_admin
                                $sql = "SELECT feedback, feedback_admin FROM phanhoi WHERE USERNAME_TK = $makh";
                                $result = $conn->query($sql);

                                // Tạo bảng thông báo
                                echo "<div class='notification-container'>";
                                echo "<div class='notification-form'>";
                                echo "<table>";
              
                                while ($row = $result->fetch_assoc()) {
                                    echo "<tr><td>".$row['feedback']."</td><td>".$row['feedback_admin']."</td></tr>";
                                }
                                echo "</table>";
                                echo "</div>";
                                echo "</div>";
